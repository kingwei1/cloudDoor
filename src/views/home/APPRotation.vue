    ...
    <div id="main">
        <div class="backLayout">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                <el-breadcrumb-item>APP首页排版</el-breadcrumb-item>
            </el-breadcrumb>
            <div class="title"><span>APP焦点图</span><span class="blue">还可以再添加{{addNum1}}个图片</span><el-button type="primary" @click='open(undefined,"添加轮播图")'>添加轮播图</el-button></div>
    ...
    export default {
        ...
        methods:{
            ...
            getImgList(){
                const token=localStorage.getItem('token')
                let that = this;
                this.$axios.get(this.$baseUrl+'/focuspic/get?token='+token+'&type=app',{})
                .then(function(res){
                	console.log(res)
                    let data = res.data.data;
